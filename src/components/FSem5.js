...
function App() {
    ...
    const update=()=>{
      fetch('https://sheetdb.io/api/v1/ud6x0i1sopuat', {
    method: 'POST',
    headers: {
  ...
  .then((data) => console.log(data));
    ...
    <section>
        ...
        <input type="text" value={cName} required onChange={(e)  => {handlecNameChange(e)}} /><br/>
        <label>
          Year
        </label><br/>
        <input type="text" value={year} required onChange={(e)  => {handleyearChange(e)}} /><br/>
        <label>
          College name
        </label><br/>
        <input type="text" value={eName} required onChange={(e)  => {handleeNameChange(e)}} /><br/>
